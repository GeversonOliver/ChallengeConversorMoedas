            ...
            try {
                ...
                switch (opcao) {
                    case 1:
                        ...
                        taxaDeCambio = url_str.requisicao("https://v6.exchangerate-api.com/v6/c4e641f8ce3d83a2397fa909/pair/USD/ARS");
                    ...
                    case 2:
                        ...
                        // Configuração da URL para usar a API
                        taxaDeCambio = url_str.requisicao("https://v6.exchangerate-api.com/v6/c4e641f8ce3d83a2397fa909/pair/ARS/USD");
                        System.out.print("Digite o valor que deseja converter: ");
                        valor = leitura.nextFloat();
                    ...
                    case 3:
                        ...
                        // Configuração da URL para usar a API
                        taxaDeCambio = url_str.requisicao("https://v6.exchangerate-api.com/v6/c4e641f8ce3d83a2397fa909/pair/USD/BRL");
                        System.out.print("Digite o valor que deseja converter: ");
                        valor = leitura.nextFloat();
                    ...
                    case 4:
                        ...
                        // Configuração da URL para usar a API
                        taxaDeCambio = url_str.requisicao("https://v6.exchangerate-api.com/v6/c4e641f8ce3d83a2397fa909/pair/BRL/USD");
                        System.out.print("Digite o valor que deseja converter: ");
                        valor = leitura.nextFloat();
                    ...
                    case 5:
                        ...
                        // Configuração da URL para usar a API
                        taxaDeCambio = url_str.requisicao("https://v6.exchangerate-api.com/v6/c4e641f8ce3d83a2397fa909/pair/USD/COP");
                        System.out.print("Digite o valor que deseja converter: ");
                        valor = leitura.nextFloat();
                    ...
                    case 6:
                        ...
                        // Configuração da URL para usar a API
                        taxaDeCambio = url_str.requisicao("https://v6.exchangerate-api.com/v6/c4e641f8ce3d83a2397fa909/pair/COP/USD");
                        System.out.print("Digite o valor que deseja converter: ");
                        valor = leitura.nextFloat();
